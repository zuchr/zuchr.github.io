...
function about() { //Hardcoded entry exclusively for the "ABOUT" button.
	...
	document.getElementById("date").innerHTML = "<img src='clock.svg'> " + "Site launched April 15th, 2022";
	document.getElementById("desc").innerHTML = "Welcome to my portfolio website! It's great to have you here. Included on this page is a sampling of some of my proudest and most recent works.<br><br>If you're an interested employer (or if you know a guy), <a href='BobbyZuch_Resume_22-8-23.pdf' target='_blank'>here is the latest version of my resume</a>.";
